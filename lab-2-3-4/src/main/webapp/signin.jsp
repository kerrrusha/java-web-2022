            ...
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4">
                  ...
                  <div class="my-3">
                    <a href="${pageContext.request.contextPath}/signup">Not registered yet?</a>
                  </div>

                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="button" onclick="processLogin('${pageContext.request.contextPath}/auth/login', '${pageContext.request.contextPath}/')" class="btn btn-primary btn-lg">
                      Login
                    </button>
                  </div>
